...
.method generateBigContentView()Landroid/widget/RemoteViews;
    ...
    .line 312
    invoke-virtual {p0, v6, v4, v6}, Landroidx/media/app/NotificationCompat$MediaStyle;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    sget v7, Landroidx/media/R$integer;->cancel_button_image_alpha:I
    ...
    iget-object v5, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mCancelButtonIntent:Landroid/app/PendingIntent;
...
.method generateContentView()Landroid/widget/RemoteViews;
    ...
    .line 243
    invoke-virtual {p0, v6, v7, v11}, Landroidx/media/app/NotificationCompat$MediaStyle;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    .end local v2    # "i":I
    :cond_2
    iget-boolean v7, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mShowCancelButton:Z

    if-eqz v7, :cond_3

    .line 266
    sget v7, Landroidx/media/R$id;->end_padder:I

    invoke-virtual {v5, v7, v9}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    .line 267
    sget v7, Landroidx/media/R$id;->cancel_action:I
    ...
    sget v9, Landroidx/media/R$integer;->cancel_button_image_alpha:I
