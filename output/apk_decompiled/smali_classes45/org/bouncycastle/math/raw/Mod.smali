...
.method public static invert([I[I[I)V
    ...
    invoke-static {v3, p1}, Lorg/bouncycastle/math/raw/Nat;->isZero(I[I)Z
    ...
    :cond_0
    invoke-static {v3, p1}, Lorg/bouncycastle/math/raw/Nat;->isOne(I[I)Z
    ...
    :cond_1
    invoke-static {v3, p1}, Lorg/bouncycastle/math/raw/Nat;->copy(I[I)[I
    ...
    invoke-static {p0, v5, v3, v6, v1}, Lorg/bouncycastle/math/raw/Mod;->inversionStep([I[II[II)I

    move-result v0

    :goto_1
    invoke-static {v3, v5}, Lorg/bouncycastle/math/raw/Nat;->isOne(I[I)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, v0, v6, p2}, Lorg/bouncycastle/math/raw/Mod;->inversionResult([II[I[I)V

    goto :goto_0

    :cond_2
    invoke-static {v3, p0}, Lorg/bouncycastle/math/raw/Nat;->copy(I[I)[I
    ...
    :cond_4
    invoke-static {v2, v5, v7}, Lorg/bouncycastle/math/raw/Nat;->gte(I[I[I)Z
    ...
    invoke-static {v3, v8, v6}, Lorg/bouncycastle/math/raw/Nat;->subFrom(I[I[I)I
    ...
    invoke-static {p0, v5, v2, v6, v0}, Lorg/bouncycastle/math/raw/Mod;->inversionStep([I[II[II)I

    move-result v0

    invoke-static {v2, v5}, Lorg/bouncycastle/math/raw/Nat;->isOne(I[I)Z
    ...
    invoke-static {v3, v6, v8}, Lorg/bouncycastle/math/raw/Nat;->subFrom(I[I[I)I
    ...
    invoke-static {p0, v7, v2, v8, v0}, Lorg/bouncycastle/math/raw/Mod;->inversionStep([I[II[II)I

    move-result v1

    invoke-static {v2, v7}, Lorg/bouncycastle/math/raw/Nat;->isOne(I[I)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p0, v1, v8, p2}, Lorg/bouncycastle/math/raw/Mod;->inversionResult([II[I[I)V
