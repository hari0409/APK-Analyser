...
.method private addRootSnake()V
    ...
    .line 589
    .local v1, "root":Landroidx/recyclerview/widget/DiffUtil$Snake;
    iput v3, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    .line 590
    iput v3, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I

    .line 591
    iput-boolean v3, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->removal:Z

    .line 592
    iput v3, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->size:I

    .line 593
    iput-boolean v3, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->reverse:Z
    ...
    .line 596
    .end local v1    # "root":Landroidx/recyclerview/widget/DiffUtil$Snake;
    :cond_1
    return-void

    .line 586
    .end local v0    # "firstSnake":Landroidx/recyclerview/widget/DiffUtil$Snake;
    :cond_2
    iget-object v2, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mSnakes:Ljava/util/List;
...
.method private dispatchAdditions(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    .line 873
    iget-boolean v4, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mDetectMoves:Z
    ...
    .line 881
    :sswitch_0
    invoke-interface {p2, p3, v7}, Landroidx/recyclerview/widget/ListUpdateCallback;->onInserted(II)V
    ...
    .line 883
    .local v3, "update":Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    iget v5, v3, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;->currentPos:I

    add-int/lit8 v5, v5, 0x1

    iput v5, v3, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;->currentPos:I

    goto :goto_1

    .line 888
    .end local v3    # "update":Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    :sswitch_1
    iget-object v4, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mNewItemStatuses:[I
    ...
    .line 889
    .local v1, "pos":I
    invoke-static {p1, v1, v7}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;

    move-result-object v3

    .line 893
    .restart local v3    # "update":Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    iget v4, v3, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;->currentPos:I

    invoke-interface {p2, v4, p3}, Landroidx/recyclerview/widget/ListUpdateCallback;->onMoved(II)V
    ...
    .line 897
    invoke-virtual {v4, v1, v5}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v4

    .line 896
    invoke-interface {p2, p3, v7, v4}, Landroidx/recyclerview/widget/ListUpdateCallback;->onChanged(IILjava/lang/Object;)V
    ...
    invoke-direct {v4, v5, p3, v6}, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;-><init>(IIZ)V
...
.method private dispatchRemovals(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    invoke-interface {p2, v4, v7}, Landroidx/recyclerview/widget/ListUpdateCallback;->onRemoved(II)V
    ...
    invoke-interface {p2, v4, v5}, Landroidx/recyclerview/widget/ListUpdateCallback;->onMoved(II)V
    ...
    .line 938
    invoke-virtual {v5, v6, v1}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v5

    .line 937
    invoke-interface {p2, v4, v7, v5}, Landroidx/recyclerview/widget/ListUpdateCallback;->onChanged(IILjava/lang/Object;)V
    ...
    invoke-direct {v4, v5, v6, v7}, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;-><init>(IIZ)V
...
.method private findMatchingItem(IIIZ)Z
    ...
    .line 733
    iget-object v10, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mSnakes:Ljava/util/List;

    invoke-interface {v10, v5}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Landroidx/recyclerview/widget/DiffUtil$Snake;

    .line 734
    .local v8, "snake":Landroidx/recyclerview/widget/DiffUtil$Snake;
    iget v10, v8, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    iget v11, v8, Landroidx/recyclerview/widget/DiffUtil$Snake;->size:I

    add-int v3, v10, v11

    .line 735
    .local v3, "endX":I
    iget v10, v8, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
    ...
    invoke-virtual {v10, v7, v6}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {v10, v7, v6}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    :goto_3
    iget-object v10, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mNewItemStatuses:[I
    ...
    invoke-virtual {v10, v6, v7}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {v10, v6, v7}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    .line 763
    :cond_6
    iget v1, v8, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    .line 764
    iget v2, v8, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
...
.method private findMatchingItems()V
    ...
    .prologue
    .line 610
    iget v8, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mOldListSize:I

    .line 611
    .local v8, "posOld":I
    iget v7, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mNewListSize:I

    .line 613
    .local v7, "posNew":I
    iget-object v11, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mSnakes:Ljava/util/List;
    ...
    iget v11, v9, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I
    ...
    .line 617
    .local v2, "endY":I
    iget-boolean v11, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mDetectMoves:Z
    ...
    .line 620
    invoke-direct {p0, v8, v7, v3}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->findAddition(III)V
    ...
    .line 626
    invoke-direct {p0, v8, v7, v3}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->findRemoval(III)V
    ...
    .line 635
    invoke-virtual {v11, v6, v5}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    .line 638
    iget-object v11, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mNewItemStatuses:[I
    ...
    :cond_3
    iget v8, v9, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    .line 641
    iget v7, v9, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
...
.method private static removePostponedUpdate(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    ...
    iput v4, v3, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;->currentPos:I
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    iget v10, v0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mOldListSize:I

    .line 829
    .local v10, "posOld":I
    move-object/from16 v0, p0

    iget v9, v0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mNewListSize:I

    .line 830
    .local v9, "posNew":I
    move-object/from16 v0, p0

    iget-object v1, v0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mSnakes:Ljava/util/List;
    ...
    iget v13, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->size:I

    .line 833
    .local v13, "snakeSize":I
    iget v1, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    add-int v4, v1, v13

    .line 834
    .local v4, "endX":I
    iget v1, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mOldItemStatuses:[I

    iget v5, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I
    ...
    iget v15, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I

    add-int/2addr v15, v8

    .line 846
    invoke-virtual {v6, v14, v15}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v6

    .line 845
    invoke-virtual {v3, v1, v5, v6}, Landroidx/recyclerview/widget/BatchingListUpdateCallback;->onChanged(IILjava/lang/Object;)V
    ...
    .line 819
    .end local v2    # "postponedUpdates":Ljava/util/List;, "Ljava/util/List<Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;>;"
    ...
    .line 849
    .restart local v2    # "postponedUpdates":Ljava/util/List;, "Ljava/util/List<Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;>;"
    ...
    :cond_4
    iget v10, v11, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I
