...
public class AppCompatAutoCompleteTextView extends android.widget.AutoCompleteTextView implements androidx.core.view.TintableBackgroundView {
    ...
    static AppCompatAutoCompleteTextView()
    {
        int[] v0_1 = new int[1];
        v0_1[0] = 16843126;
        androidx.appcompat.widget.AppCompatAutoCompleteTextView.TINT_ATTRS = v0_1;
        return;
    }

    public AppCompatAutoCompleteTextView(android.content.Context p2)
    {
        this(p2, 0);
        return;
    }

    public AppCompatAutoCompleteTextView(android.content.Context p2, android.util.AttributeSet p3)
    {
        this(p2, p3, androidx.appcompat.R$attr.autoCompleteTextViewStyle);
        return;
    }

    public AppCompatAutoCompleteTextView(android.content.Context p5, android.util.AttributeSet p6, int p7)
    {
        super(androidx.appcompat.widget.TintContextWrapper.wrap(p5), p6, p7);
        androidx.appcompat.widget.TintTypedArray v0 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(super.getContext(), p6, androidx.appcompat.widget.AppCompatAutoCompleteTextView.TINT_ATTRS, p7, 0);
        if (v0.hasValue(0)) {
