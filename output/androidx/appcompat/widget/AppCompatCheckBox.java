...
public class AppCompatCheckBox extends android.widget.CheckBox implements androidx.core.widget.TintableCompoundButton {
    ...
    public AppCompatCheckBox(android.content.Context p2)
    {
        this(p2, 0);
        return;
    }

    public AppCompatCheckBox(android.content.Context p2, android.util.AttributeSet p3)
    {
        this(p2, p3, androidx.appcompat.R$attr.checkboxStyle);
        return;
    }

    public AppCompatCheckBox(android.content.Context p2, android.util.AttributeSet p3, int p4)
    {
