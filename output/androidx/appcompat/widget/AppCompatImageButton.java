...
public class AppCompatImageButton extends android.widget.ImageButton implements androidx.core.view.TintableBackgroundView, androidx.core.widget.TintableImageSourceView {
    ...
    public AppCompatImageButton(android.content.Context p2)
    {
        this(p2, 0);
        return;
    }

    public AppCompatImageButton(android.content.Context p2, android.util.AttributeSet p3)
    {
        this(p2, p3, androidx.appcompat.R$attr.imageButtonStyle);
        return;
    }

    public AppCompatImageButton(android.content.Context p2, android.util.AttributeSet p3, int p4)
    {
