...
public class DpcEditTextPreference extends androidx.preference.EditTextPreference implements com.afwsamples.testdpc.common.preference.DpcPreferenceBase {
    private com.afwsamples.testdpc.common.preference.DpcPreferenceHelper mHelper;

    public DpcEditTextPreference(android.content.Context p2)
    {
        this(p2, 0);
        return;
    }

    public DpcEditTextPreference(android.content.Context p2, android.util.AttributeSet p3)
    {
        this(p2, p3, 2130968709);
        return;
    }

    public DpcEditTextPreference(android.content.Context p2, android.util.AttributeSet p3, int p4)
    {
        this(p2, p3, p4, 0);
        return;
    }

    public DpcEditTextPreference(android.content.Context p2, android.util.AttributeSet p3, int p4, int p5)
    {
        super(p2, p3, p4, p5);
