...
public class DpcPreference extends androidx.preference.Preference implements com.afwsamples.testdpc.common.preference.DpcPreferenceBase {
    private com.afwsamples.testdpc.common.preference.DpcPreferenceHelper mHelper;

    public DpcPreference(android.content.Context p2)
    {
        this(p2, 0);
        return;
    }

    public DpcPreference(android.content.Context p2, android.util.AttributeSet p3)
    {
        this(p2, p3, 2130968867);
        return;
    }

    public DpcPreference(android.content.Context p2, android.util.AttributeSet p3, int p4)
    {
        this(p2, p3, p4, 0);
        return;
    }

    public DpcPreference(android.content.Context p2, android.util.AttributeSet p3, int p4, int p5)
    {
        super(p2, p3, p4, p5);
